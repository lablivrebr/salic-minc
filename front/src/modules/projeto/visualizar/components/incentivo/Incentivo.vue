  ...
  <div id="conteudo">
    ...
    <div v-if="Object.keys(dadosProjeto).length > 0">
      <table class="tabela">
        ...
        <tr>
          <td>
            <span v-if="dadosProjeto.idUsuarioExterno">
              <SalicFormatarCpfCnpj
                :cpf="dadosProjeto.CgcCPf"
              />
            </span>
            <a
              v-else
      ...
      >
        ...
        <tr>
          <td align="center">
            {{ dadosProjeto.DtSituacao | formatarData }}
          </td>
      ...
      <table class="tabela">
        ...
        <tr>
          <td class="left-align">
            {{ dadosProjeto.FaseProjeto }}
          </td>
          <td align="center">
            {{ dadosProjeto.dtInicioFase | formatarData }}
          </td>
        </tr>
      </table>
      ...
      <table class="tabela">
        ...
        <tr>
          <td class="left-align destacar-celula">
            {{ dadosProjeto.Normativo }}
          </td>
          <td align="center">
            {{ dadosProjeto.dtPublicacaoNormativo | formatarData }}
          </td>
          <td align="center">
            {{ dadosProjeto.dtRevogacaoNormativo | formatarData }}
          </td>
        </tr>
      </table>
      ...
      <table
        ...
        class="tabela"
      >
        <caption style="color: red !important;">
        ...
        <tr>
          <td align="center">
            {{ dadosProjeto.DtArquivamento | formatarData }}
          </td>
          <td align="center">
