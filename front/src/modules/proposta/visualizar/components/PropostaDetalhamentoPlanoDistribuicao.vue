          ...
          <table>
            <thead v-if="detalhamento.length > 0">
              ...
              <tr>
                ...
                <th class="right-align popular">
                  Pre&ccedil;o <br> Unit&aacute;rio
                </th>
            ...
            <tbody v-if="detalhamento.length > 0">
              ...
              >
                ...
                <td class="right-align">
                  {{ item.qtPopularIntegral }}
                </td>
                <td class="right-align">
                  {{ item.qtPopularParcial }}
                </td>
                <td class="right-align">
                ...
                <td class="right-align">
                  {{ item.qtProponenteIntegral }}
                </td>
                <td class="right-align">
                  {{ item.qtProponenteParcial }}
                </td>
                <td class="right-align">
                ...
                <td class="right-align">
                  {{ item.vlReceitaPrevista | filtroFormatarParaReal }}
                </td>
              </tr>
            </tbody>
