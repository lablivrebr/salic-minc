    ...
    >
      ...
      <li>
        ...
        >
          <i class="material-icons">
            subject
          </i>Democratiza&ccedil;&atilde;o de Acesso
        </div>
        <div
          v-if="dadosAtuais"
          class="collapsible-body padding20"
      ...
      <li>
        ...
        >
          <i class="material-icons">
            subject
          </i>Descri&ccedil;&atilde;o de Atividades
        </div>
        <div
          v-if="dadosAtuais"
          class="collapsible-body padding20"
      ...
      <li>
        ...
        >
          <i class="material-icons">
            equalizer
          </i>Plano Distribui&ccedil;&atilde;o
        </div>
        <div class="collapsible-body padding20">
          <div class="row">
            <div class="col s12 m6 l6 scroll historico">
