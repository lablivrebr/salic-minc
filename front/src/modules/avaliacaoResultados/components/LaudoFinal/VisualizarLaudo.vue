        ...
        <v-card>
          ...
          >
            ...
            >
              ...
              >
                <div>
                  <p v-if="parecerLaudoFinal.items.siManifestacao == 'A'">
                    <b>Manifestação: </b> Aprovado
                  </p>
                  <p v-else-if="parecerLaudoFinal.items.siManifestacao == 'P'">
                    <b>Manifestação: </b> Aprovado com ressalva
                  </p>
                  <p v-else-if="parecerLaudoFinal.items.siManifestacao == 'R'">
