  ...
  <div id="conteudo">
    <div>
      ...
      <table class="tabela">
        ...
        <tr>
          <td align="center">
            {{ dadosProjeto.UfProjeto }}
          </td>
          <td align="center">
            {{ dadosProjeto.Mecanismo }}
          </td>
          <td align="center">
            {{ dadosProjeto.Area }}
          </td>
          <td align="center">
            {{ dadosProjeto.Segmento }}
          </td>
          <td align="center">
            {{ dadosProjeto.Processo }}
          </td>
        </tr>
      </table>
      ...
      >
        <tr class="destacar">
          <th
            ...
            rowspan="2"
          >
            <b>Per&iacute;odo de vig&ecirc;ncia</b>
          </th>
          <th
            align="center"
            colspan="3"
        ...
        <tr class="destacar">
          <th align="center">
            <b>N&ordm; Conv&ecirc;nio</b>
          </th>
          <th align="center">
            <b>Dt. Conv&ecirc;nio</b>
          </th>
          <th align="center">
            <b>Dt. Publica&ccedil;&atilde;o</b>
          </th>
        </tr>
        <tr>
          <td align="center">
            {{ dadosProjeto.DtConvenioPrimeiraVigencia }} &agrave;
            {{ dadosProjeto.DtConvenioUltimaVigencia }}
          </td>
          <!-- OBS:período entre essas datas-->
          <td align="center">
            {{ dadosProjeto.NrConvenio }}
          </td>
          <td align="center">
            {{ dadosProjeto.DtConvenio }}
          </td>
          <td align="center">
            {{ dadosProjeto.DtConvenioPublicacao }}
          </td>
        </tr>
      </table>
      ...
      <table class="tabela">
        <tr class="destacar">
          <th
            ...
            colspan="4"
          >
            <b>Situa&ccedil;&atilde;o do Projeto</b>
          </th>
        </tr>
        <tr class="destacar">
        ...
        <tr>
          <td align="center">
            {{ dadosProjeto.DtSituacao }}
          </td>
          <td align="center">
            {{ dadosProjeto.Situacao }}
          </td>
          <td align="center">
            {{ dadosProjeto.ProvidenciaTomada }}
          </td>
          <td align="center">
            {{ dadosProjeto.LocalizacaoAtual }}
          </td>
        </tr>
      </table>
      ...
      >
        ...
        <tr>
          <td align="center">
            {{ dadosProjeto.DtArquivamento }}
          </td>
          <td align="center">
            {{ dadosProjeto.CaixaInicio }}
          </td>
          <td align="center">
            {{ dadosProjeto.CaixaFinal }}
          </td>
        </tr>
      </table>
