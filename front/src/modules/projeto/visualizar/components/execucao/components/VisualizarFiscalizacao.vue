          ...
          >
            ...
            <v-layout>
              ...
              >
                ...
                <p v-else-if="dado.tpDemandante == 1">
                  SAV
                </p>
              </v-flex>
              <v-flex
              ...
              >
                ...
                <p v-if="dado.dtResposta.length > 1">
                  {{ dado.dtResposta }}
                </p>
                <p
          ...
          <v-card v-if="parecer.stDtDeCorte == 1">
            <v-subheader class="justify-center">
              <div>
                <h4 class="display-1 grey--text text--darken-4 font-weight-light">
                  Situação do
                  Convênio na Realização da Fiscalização
                </h4>
              </div>
            </v-subheader>
            <v-container>
            ...
            <v-container>
              <v-layout>
                ...
                >
                  ...
                  <p>
                    <b>
                      Foi apurado por unidade fiscalizadora ou auditora a aplicação irregular de
                      recursos?
                    </b>
                  </p>
              ...
              <v-layout>
                <v-flex
                  ...
                  offset-xs1
                >
                  <div v-if="parecer.stDtDeCorte == 0">
                    <br>
                    <p>
                      <b>
                        Há compatibilidade entre os recursos transferidos e a evolução do
                        projeto?
                      </b>
                    </p>
                  </div>
                  <div v-else-if="parecer.stDtDeCorte == 1">
                    <br>
                    <p><b>Há compatibilidade entre o desembolso e a evolução?</b></p>
                  </div>
              ...
              <v-layout>
                ...
                >
                  ...
                  <p>
                    <b>
                      Ocorreu despesas com multas, juros, taxas bancárias ou correção
                      monetária?
                    </b>
                  </p>
              ...
              <v-layout v-if="parecer.stDtDeCorte == 1">
                ...
                >
                  ...
                  <p>
                    <b>
                      Há transferência de recurso para clubes/associações ou outras entidades
                      congêneres?
                    </b>
                  </p>
              ...
              <v-layout v-if="parecer.stDtDeCorte == 1">
                ...
                >
                  ...
                  <p>
                    <b>
                      Há despesas com publicidade, salvo as de caráter educativo, informativo ou
              ...
              <v-layout>
                ...
                >
                  <div v-if="parecer.stDtDeCorte == 0">
                    ...
                    <p>
                      <b>
                        Os recursos de contrapartida foram depositados na conta do
                        projeto?
                      </b>
                    </p>
                  </div>
                  <div v-else-if="parecer.stDtDeCorte == 1">
                    <br>
                    <p><b>Não foram aplicados os recursos de contrapartida?</b></p>
                  </div>
              ...
              <v-layout>
                ...
                >
                  ...
                  <p>
                    <b>
                      Ocorreu aplicação de recursos em outra finalidade que não a do objeto
                      pactuado?
                    </b>
                  </p>
              ...
              <v-layout v-if="parecer.stDtDeCorte == 0">
                ...
                >
                  ...
                  <p>
                    <b>
                      Os recursos captados estão sendo aplicados em conformidade com a
                      legislação vigente?
                    </b>
                  </p>
            ...
            <v-container>
              <v-layout>
                ...
                >
                  <div v-if="parecer.stDtDeCorte == 0">
                    ...
                    <p>
                      <b>
                        O proponente/convenente tem mantido a documentação relativa ao projeto
                        em arquivo próprio?
                      </b>
                    </p>
                  </div>
                  <div v-else-if="parecer.stDtDeCorte == 1">
                    <br>
                    <p><b>O processo está bem documentado?</b></p>
                  </div>
              ...
              <v-layout>
                ...
                >
                  <div v-if="parecer.stDtDeCorte == 0">
                    <br>
                    <p><b>Identificam o projeto com o número do Pronac/Convênio?</b></p>
                  </div>
                  <div v-if="parecer.stDtDeCorte == 1">
                    <br>
                    <p><b>Identificam o nome do projeto e o número do convênio?</b></p>
                  </div>
            ...
            <v-container>
              ...
              <v-layout v-if="parecer.stDtDeCorte == 1">
                ...
                >
                  <br>
                  <p>
                    <b>As metas/etapas do Plano de Trabalho foram executadas integralmente?</b>
                  </p>
              ...
              <v-layout>
                ...
                >
                  <div v-if="parecer.stDtDeCorte == 0">
                    <br>
                    <p><b>O projeto está sendo executado de acordo com o aprovado?</b></p>
                  </div>
                  <div v-if="parecer.stDtDeCorte == 1">
                    <br>
                    <p><b>A execução respeitou o aprovado?</b></p>
                  </div>
