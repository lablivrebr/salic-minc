      ...
      >
        ...
        >
          ...
          >
            ...
            <td class="text-xs-right">
              {{ props.item.qtPopularIntegral }}
            </td>
            <td class="text-xs-right">
              {{ props.item.qtPopularParcial }}
            </td>
            <td class="text-xs-right">
              {{ props.item.vlUnitarioPopularIntegral }}
            </td>

            <td class="text-xs-right">
              {{ props.item.qtProponenteIntegral }}
            </td>
            <td class="text-xs-right">
              {{ props.item.qtProponenteParcial }}
            </td>
            <td class="text-xs-right">
              {{ props.item.vlUnitarioProponenteIntegral }}
            </td>

            <td class="text-xs-right">
              {{ props.item.vlReceitaPrevista }}
            </td>
          </template>
        </v-data-table>
      </v-expansion-panel-content>
